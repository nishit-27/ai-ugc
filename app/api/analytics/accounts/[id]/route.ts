  ...
  try {
    ...
    return NextResponse.json({
      account: {
        ...
        totalViews: Number(account.totalViews),
        totalLikes: Number(account.totalLikes),
        totalComments: Number(account.totalComments),
        totalShares: Number(account.totalShares),
        engagementRate: Number(account.engagementRate),
