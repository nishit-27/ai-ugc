...
import ComposeUploadTab from './ComposeUploadTab';
import ComposeUrlTab from './ComposeUrlTab';
import ComposeJobsTab from './ComposeJobsTab';
      ...
      <div className="flex-1 overflow-y-auto p-3">
        ...
        {activeTab === 'jobs' && (
          <ComposeJobsTab
            ...
            isLoadingBatchJobs={isLoadingBatchJobs}
            standaloneJobs={standaloneJobs}
            jobBatches={jobBatches}
            expandedBatchId={expandedBatchId}
            expandedBatchJobs={expandedBatchJobs}
            onAddLayer={onAddLayer}
            onExpandBatch={expandBatch}
          />
        )}
        ...
        {activeTab === 'url' && (
          <ComposeUrlTab urlInput={urlInput} setUrlInput={setUrlInput} onAdd={handleUrlAdd} />
        )}
      </div>
    </div>
  );
